...
import static dev.gkvn.cpu.fl32r.assembler.frontend.arch.FEOpCode.*;
import static dev.gkvn.cpu.fl32r.assembler.backend.isa.PseudoInstructions.*;
import static dev.gkvn.cpu.fl32r.assembler.backend.isa.CodegenUtils.*;
...
import dev.gkvn.cpu.fl32r.emulator.FL32RConstants;
...
public class CodegenTable {
	...
	static {
		...
		entry(LIFR,  rType(FL32RConstants.LIFR));
		entry(LIPR,  rType(FL32RConstants.LIPR));
		entry(STFS,  rType(FL32RConstants.STFS));
